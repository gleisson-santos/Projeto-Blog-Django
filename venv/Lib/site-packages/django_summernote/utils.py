...
SUMMERNOTE_THEME_FILES = {
    ...
    "lite": {
        "base_css": (),
        "base_js": ("//code.jquery.com/jquery-3.6.0.min.js",),
        "default_css": (
...
def get_attachment_storage():
    ...
    if config["attachment_storage_class"]:
        ...
        try:
            ...
            raise ImproperlyConfigured("%s is not a valid module" % storage_path)

        storage_module, storage_classname = storage_path[:dot], storage_path[dot + 1 :]
